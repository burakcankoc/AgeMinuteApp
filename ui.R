...
ui <- fluidPage(
    ...
    sidebarPanel(style = "background-color: #222831",
                 fluidRow(column(
                   ...
                   selectInput(
                     ...
                     selected = df$League[sample(1:length(df$League), 1)]
                   )
                 )),
                 fluidRow(
                   column(8,
  ...
  h4(paste0("Last updated on: December 10, 2021"), style = "color: #F7F7F7"),
  h4(
    "All stats from ",
    style = "color: #F7F7F7",
    id = "FBREF-links",
    tags$a(href = "https://fbref.com/en/", target = "_blank", "Football Reference")
  ),
  h4(
    "Developed by",
    style = "color: #F7F7F7",
